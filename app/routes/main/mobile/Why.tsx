...
export default function MobileWhy(): JSX.Element {
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    고기를 경매하여 직접 발골하고 1차 유통부터 2차 유통까지 하는
                    업체는 그리 많지 않습니다.
                    <br />
                    <br />
                    세화축산의 㸷花 는 ‘뿔이 우뚝 솟은 소가 꽃이되다’ 라는
                    의미입니다. 마블링이 좋은 한우는 꽃갈비살, 꽃등심처럼 흔히
                    ‘꽃이 피어다’ 라는 표현을 사용합니다. 품질 좋은 한우로 고기
                    맛을 기준을 새롭게 세워드리고, 고객님의 입맛을 세워드리도록
                    최선을 다하겠습니다.
                  </Typography>
